      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="text-center">
            <b-button id="show-btn" @click="$bvModal.show('{{courseData.id}}')"><img class="img-fluid" v-bind:src="courseData.image"></b-button>
            <b-modal size="lg" v-bind:id="courseData.id" hide-footer>
