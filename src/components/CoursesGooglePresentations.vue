<template>
  <ul class="d-flex flex-wrap google-presentations-list">
        ...
        <div class="card">
          ...
          <div class="card-footer">
            <div class="d-flex justify-content-between align-items-center">
              <span class="course-type-google"></span>
...
<script>
  ...
  export default {
    ...
    mounted () {
      axios.get("course.json").then(response => (this.courseDataList = response.data.googlepresentations));
    }
  }
</script>